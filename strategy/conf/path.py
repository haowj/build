...
__author__ = 'xcma'
import time
from appack.conf.config import config_branch

# plug_domain = 'http://plug.superhcloud.com/'
plug_domain = 'http://build.plug.superhcloud.com/'
...
out_base_path = '/home/zjzy/build_output/'
out_workplace = 'workplace/'
out_super_data = 'superd/'
out_super_conf_data = 'superdconf/'
out_super_api_loader = 'sapiloaderc/'
out_proxy_data = 'reverse_proxy/'
out_dpi_conf_data= 'dpi_conf/'
out_build_tmp_path = out_base_path + out_workplace
...
proxy_client_build_shell_path_name = proxy_client_build_shell_path + '/cbuild.sh'
